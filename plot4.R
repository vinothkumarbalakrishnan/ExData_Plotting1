...
plot(as.POSIXct(paste(householdelectricdatasubset$Date, householdelectricdatasubset$Time), 
                format="%Y-%m-%d %H:%M:%S"), as.numeric(householdelectricdatasubset$Global_active_power)/1000,
     xlab = "",
...
plot(as.POSIXct(paste(householdelectricdatasubset$Date, householdelectricdatasubset$Time), 
                format="%Y-%m-%d %H:%M:%S"), 
     as.numeric(as.character(householdelectricdatasubset$Voltage)) ,
     type = 'l',
     ##xlim = c(234, 246),
     xlab = "datetime",
     ylab = "Voltage",
...
plot(as.POSIXct(paste(householdelectricdatasubset$Date, householdelectricdatasubset$Time), 
                format="%Y-%m-%d %H:%M:%S"), 
     as.numeric(as.character(householdelectricdatasubset$Global_reactive_power)) ,
     type = 'l',
     ##xlim = c(234, 246),
     xlab = "datetime",
